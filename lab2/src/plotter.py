...
edges_directory = 'res/LocalSearchCycleEdges'
...
for file in os.listdir(vertices_directory):
    if file.endswith(".tsp"):
        ...
        plt.grid(True)
        plt.savefig(f'res\\plots\\LocalSearchPlots\\Local_Search_cycle_plot_{os.path.splitext(os.path.basename(file.name))[0]}.png')
        plt.close()